  ...
  <form [formGroup]="formAllInfo" class="form" (submit)="onAuth()">
    <div class="container">
      ...
      <div class="example-container">
        ...
        <button class="btn mr-30" mat-raised-button color="primary" (click)="authService.SignIn(userName.value, userPassword.value)" [disabled]="!formAllInfo.valid">Войти</button>
